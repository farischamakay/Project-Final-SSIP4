...
urlpatterns = [
    ...
    path('', character_controller.list_characters, name='character_index'),
    ...
    path('', rarity_controller.list_raritys, name='rarity_raritys'),
    ...
    path('', gender_controller.list_genders, name='gender_genders'),
    path('', element_controller.list_elements, name='element_elements'),
    path('', nation_controller.list_nations, name='nation_nations'),
    path('', weapon_controller.list_weapons, name='weapon_weapons'),    
